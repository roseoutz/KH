	...
	<tr>
		...
		<table border="0" width="80%">
			...
			<tr>
				<td>
					<p align="right">
						<font size="2"><a href="./GoodsAdd.ag">상품등록</a></font>
						<font size="2"><a href="./AdminOrderList.ao">배송관리</a></font>
					</p>
				</td>
			</tr>
			<tr>
				<td>
					<form name="goodsform" method="post">
						<table border="1">
							...
							<tr>
								<td>
									<p align="center"><font size="2"><%=agb.getGOODS_NUM() %></font></p>
								</td>
								<td>
									<p align="center"><font size="2"><%=agb.getGOODS_CATEGORY() %></font></p>
								</td>
								<td>
									<p align="center"><img src="./upload/<%=agb.getGOODS_IMAGE().split(",")[0] %>" width="50" height="50" border="0"></p>
								</td>
								<td>
									<p align="center"><font size="2"><%=agb.getGOODS_NAME() %></font></p>
								</td>
								<td>
									<p align="center"><font size="2"><%=agb.getGOODS_PRICE() %></font></p>
								</td>
								<td>
									<p align="center"><font size="2"><%=agb.getGOODS_AMOUNT() %></font></p>
								</td>
								<td>
									<p align="center"><font size="2"><%=agb.getGOODS_DATE().substring(0,10) %></font></p>
								</td>
								<td>
									<p align="center">
