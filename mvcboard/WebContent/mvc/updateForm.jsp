...
<script language="javascript" src="srcript.js"></script>
</head>
<body bgcolor="${bodyback_c }">
<center><b>글수정</b>
<br>
<form method="post" name="writeform" action="/mvcboard/mvc/updatePro.do?pageNum=${pageNum }" onsubmit="return writeSave()">
<table width="400" border="1" cellspacing="0" cellpadding="0" align="center">
	...
	<tr>
		<td colspan="2" bgcolor="${value_c }" align="center">
			...
			<input type="button" value="목록보기" onclick="document.location.href='/mvcboard/mvc/list.do?pageNum=${pageNum}'">
	</tr>
</table>
</form>
</body>
